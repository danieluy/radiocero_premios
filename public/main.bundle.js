...
var Const = (function () {
    ...
    Const.URL = "http://" + window.location.hostname + ":1043/";
    Const.APIURL = "http://" + window.location.hostname + ":1043/api/";
    Const.HEADERS = {
        json: function () {
...
var LoginService = (function () {
    ...
    LoginService.prototype.login = function (userName, password) {
        var _this = this;
        return this.http.post(__WEBPACK_IMPORTED_MODULE_7__const_class__["a" /* Const */].URL + "login", "userName=" + userName + "&password=" + password, { headers: __WEBPACK_IMPORTED_MODULE_7__const_class__["a" /* Const */].HEADERS.urlencoded(), withCredentials: true })
    ...
    LoginService.prototype.logout = function () {
        var _this = this;
        return this.http.post(__WEBPACK_IMPORTED_MODULE_7__const_class__["a" /* Const */].URL + "logout", '', { headers: __WEBPACK_IMPORTED_MODULE_7__const_class__["a" /* Const */].HEADERS.urlencoded(), withCredentials: true })
            .subscribe(function (res) {
...
var Prize = (function () {
    function Prize(id, type, sponsor, description, stock, periodic, note, set_date, update_date, due_date, total_handed) {
        this.id = id;
        this.type = type;
...
var PrizesService = (function () {
    ...
    PrizesService.prototype.fetchPrizes = function () {
        var _this = this;
        this.http.get(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "prizes", { withCredentials: true })
            .map(function (res) { return res.json().map(function (p) { return new __WEBPACK_IMPORTED_MODULE_6__prize_class__["a" /* Prize */](p.id, p.type, p.sponsor, p.description, p.stock, p.periodic, p.note, p.set_date, p.update_date, p.due_date, p.total_handed); }); })
            .subscribe(function (prizes) { _this.prizes_source.next(prizes); }, function (error) {
            _this.notificationService.error("Error descargando los premios", (error.stack ? error.stack : error));
            console.error(error.stack ? error.stack : error);
        });
    };
    PrizesService.prototype.newPrize = function (prize) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "prizes", this.newPrizeComposeParameters(prize), { headers: __WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].HEADERS.urlencoded(), withCredentials: true })
            .map(function (res) { return res.json(); });
    };
    ...
    PrizesService.prototype.editPrize = function (prize) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "prizes/edit", this.editPrizeComposeParameters(prize), { headers: __WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].HEADERS.urlencoded(), withCredentials: true })
            .map(function (res) { return res.json(); });
    };
    PrizesService.prototype.editPrizeComposeParameters = function (prize) {
        var params = "id=" + prize.id + "&type=" + prize.type + "&sponsor=" + prize.sponsor + "&description=" + prize.description + "&periodic=" + prize.periodic + "&total_handed=" + prize.total_handed;
        if (prize.stock)
            params += "&stock=" + prize.stock;
        if (prize.due_date)
            params += "&due_date=" + prize.StrDueDateToPost;
    ...
    PrizesService.prototype.grantPrize = function (prize, winner) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "grantprize", this.grantPrizeComposeParameters(prize, winner), { headers: __WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].HEADERS.urlencoded(), withCredentials: true })
            .map(function (res) { return res.json(); });
    };
...
var WinnersService = (function () {
    ...
    WinnersService.prototype.fetchWinners = function () {
        var _this = this;
        this.http.get(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "winners", { withCredentials: true })
            .map(function (res) { return res.json()
            ...
            .subscribe(function (winners) { return _this.winners_source.next(winners); }, function (error) {
            console.error(error);
            _this.notificationService.error("Error descargando los ganadores", "Debes iniciar sesión para ver esta información");
        });
    };
    WinnersService.prototype.handOverPrize = function (winner_ci, prize_id) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "winners/handprize", "winner_ci=" + winner_ci + "&prize_id=" + prize_id, { headers: __WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].HEADERS.urlencoded(), withCredentials: true })
            .map(function (res) { return res.json(); });
    };
    WinnersService.prototype.cancelHandOverPrize = function (winner_ci, prize_id) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "winners/cancelHandprize", "winner_ci=" + winner_ci + "&prize_id=" + prize_id, { headers: __WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].HEADERS.urlencoded(), withCredentials: true })
            .map(function (res) { return res.json(); });
    };
    WinnersService.prototype.checkWinnerCi = function (ci) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "winners/checkwinner", "ci=" + ci, { headers: __WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].HEADERS.urlencoded(), withCredentials: true })
            .map(function (res) { return res.json(); });
    };
...
var PrizesComponent = (function () {
    ...
    PrizesComponent.prototype.ngOnInit = function () {
        ...
        this.new_prize = new __WEBPACK_IMPORTED_MODULE_4__prizes_prize_class__["a" /* Prize */](null, null, null, null, null, null, null, null, null, null, null);
    };
        ...
        if (this.validateCi(ci)) {
            this.winnersService.checkWinnerCi(ci)
                ...
                if (res.allowed && res.message === 'This person is allowed to participate but has already won') {
                    _this.winner.id = res.winner.id;
                    _this.winner.ci = res.winner.ci;
                    _this.winner.name = res.winner.name;
                    _this.winner.lastname = res.winner.lastname;
                    _this.winner.facebook = res.winner.facebook;
                    _this.winner.gender = res.winner.gender;
                    _this.winner.phone = res.winner.phone;
                    _this.winner.mail = res.winner.mail;
                    _this.winner.prizes = res.winner.prizes;
                    _this.winner.set_date = res.winner.set_date;
                    _this.winner.update_date = res.winner.update_date;
...
var UsersService = (function () {
    ...
    UsersService.prototype.fetchUsers = function () {
        var _this = this;
        this.http.get(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "users", { withCredentials: true })
    ...
    UsersService.prototype.newUser = function (user) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].APIURL + "users", "name=" + user.name + "&password=" + user.password + "&role=" + user.role + "&email=" + user.email, { headers: __WEBPACK_IMPORTED_MODULE_5__const_class__["a" /* Const */].HEADERS.urlencoded(), withCredentials: true })
            .map(function (res) { return res.json(); });
    };
...
var WinnersComponent = (function () {
    ...
    WinnersComponent.prototype.cancelHandOverPrize = function (winner_ci, prize_id) {
        var _this = this;
        this.winnersService.cancelHandOverPrize(winner_ci, prize_id)
            .subscribe(function (res) {
            _this.winnersService.fetchWinners();
            _this.notificationService.ok("Exito", "El premio se a devuelto correctamente", 3000);
        }, function (error) { return _this.notificationService.error("Error, el premio NO ha sido devuelto", error._body); });
    };
